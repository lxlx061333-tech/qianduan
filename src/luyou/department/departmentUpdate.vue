<template>
  <div class="styi">
    ...
    <div v-for="department in data" :key="department.departmentId">
      <div>
        <div class="student-card">
          <div class="student-info">

            <div class="info-item">
              <span class="info-label">院系编号</span>
              <span class="info-content">{{ department.departmentId }}</span>
            </div>

            <div class="info-item">
              <span class="info-label">院系名称</span>
              <span class="info-content">{{ department.departmentName }}</span>
            </div>

            <div class="button-group">
              <button class="submit-btn" @click="submitForm(department.departmentId)">
                <span>修改信息</span>
              </button>
            </div>
...
function submitForm(departmentId) {
  userouter.push({
    path: "/guanliyuanYe/departmentUpdateYe",
    query: {
      id: departmentId,
    }
  })
