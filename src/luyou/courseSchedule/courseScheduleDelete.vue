        ...
        <div class="student-card">
          <div class="student-info">
            ...
            <div class="button-group">
              <button class="reset-btn" @click="submitForm(CourseSchedule.scheduleId, CourseSchedule.courseName)">
                <span>删除信息</span>
              </button>
            </div>
...
import router from '../../router/yilu';
const data = ref([])
...
function submitForm(scheduleId, name) {
  ...
  if (zhen) {
    axios({
      url: '/CourseSchedule/updateDelete',
      params: {
