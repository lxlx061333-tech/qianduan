<template>
  <div class="styi">
    ...
    <div v-for="major in data" :key="major.majorId">
      <div>
          ...
          <div class="student-info">
            ...
            <div class="info-row">
              <div class="info-item">
                ...
                <span class="info-content">{{ major.majorId }}</span>
              </div>
              <div class="info-item">
                <span class="info-label">专业名称</span>
                <span class="info-content">{{ major.majorName }}</span>
              </div>
            </div>

            <div class="info-item">
              <span class="info-label">所属院系 </span>
              <span class="info-content">{{ major.department.departmentName }}</span>
            </div>

            <div class="button-group">
              <button class="reset-btn" @click="submitForm(major.majorId,major.majorName)">
                <span>删除信息</span>
              </button>
            </div>
...
function submitForm(majorId,name){
  let zhen = confirm(`确定要${name}吗？`)
  if (zhen) {
    axios({
      url: '/Major/updateDelete',
      params: {
        majorId: majorId
      }
    }).then(req => {
