          ...
          <div class="student-card">
            <div class="student-info">
              ...
              <div class="button-group">
                <button class="submit-btn" @click="submitForm(studentCourse.score.scoreId,
                                                student.name,studentCourse.courseSchedule.courseName)">
                  <span>修改信息</span>
                </button>
              </div>
            </div>
  ...
  axios({
    ...
    if (req.data === '' || req.data.length === 0) {
      ...
      userouter.push({
        ...
        query: {
          name: sou.value,
          yuan: '/teacherYe/teacherscoreUpdate'
        }
      })
    } else {
...
function submitForm(scoreId,studentName,courseName){
  userouter.push({
    path:"/teacherYe/teacherscoreUpdateYe",
    query:{
      scoreId:scoreId,
