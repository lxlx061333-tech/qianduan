        ...
        <div class="student-card">
          <div class="student-info">
            ...
            <div class="button-group">
              <button class="reset-btn" @click="submitForm(CourseSchedule.courseName, CourseSchedule.scheduleId)">
                <span>删除</span>
              </button>
            </div>
          </div>
  ...
  axios({
    ...
    if (req.data === '') {
      userouter.push({
        ...
        query: {
          name: sou.value,
          yuan: '/guanliyuanYe/courseSelectionDelete'
        }
      })
    } else {
...
function submitForm(name, scheduleId) {
  let zhen = confirm(`确定删除${name}吗?`)
  if (zhen) {
    axios({
      url: '/CourseSelection/updateDelete',
      params: {
