<template>
  <div class="styi">
    <div v-for="admin in data" :key="admin.admiId">
        <div>
            ...
            <div class="student-info">
              ...
              <div class="info-row">
                <div class="info-item">
                  ...
                  <span class="info-content">{{ admin.name }}</span>
                </div>
                <div class="info-item">
                  <span class="info-label">学号</span>
                  <span class="info-content">{{ admin.studentId }}</span>
                </div>
              </div>
              ...
              <div class="info-row">
                ...
                <div class="info-item">
                  ...
                  <span class="info-content">{{ admiCourse.score.finalGrade }}</span>
                </div>
              </div>
              ...
              <div class="info-item full-width">
                ...
                <span class="info-content">{{ admi.phone }}</span>
              </div>
